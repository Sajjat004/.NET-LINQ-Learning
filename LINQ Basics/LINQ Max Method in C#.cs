...
namespace Test
{
    public class Test
    {
        ...
        {
            // Max salary using Query Syntax
            Console.WriteLine("Max salary using Query Syntax");
            var querySyntax = (from emp in Employee.GetAllEmployees()
                               select emp).Max(emp => emp.Salary);
            Console.WriteLine("Max salary: " + querySyntax);

            // Max salary using Method Syntax
            Console.WriteLine("\nMax salary using Method Syntax");
            var methodSyntax = Employee.GetAllEmployees().Max(emp => emp.Salary);
            Console.WriteLine("Max salary: " + methodSyntax);

            // Max salary of IT department using Query Syntax
            Console.WriteLine("\nMax salary of IT department using Query Syntax");
            var querySyntax1 = (from emp in Employee.GetAllEmployees()
                                where emp.Department == "IT"
                                select emp).Max(emp => emp.Salary);
            Console.WriteLine("Max salary of IT department: " + querySyntax1);

            // Max salary of IT department using Method Syntax
            Console.WriteLine("\nMax salary of IT department using Method Syntax");
            var methodSyntax1 = Employee.GetAllEmployees().Where(emp => emp.Department == "IT").Max(emp => emp.Salary);
            // var methodSyntax1 = Employee.GetAllEmployees().Max(emp => emp.Department == "IT" ? emp.Salary : 0);
            Console.WriteLine("Max salary of IT department: " + methodSyntax1);
        }
    }
