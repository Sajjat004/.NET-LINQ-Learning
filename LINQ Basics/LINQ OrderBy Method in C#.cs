...
namespace Test
{
    public class Test
    {
        ...
        {
            // Sort the student by their branch using query syntax
            Console.WriteLine("Sort the student by their branch using query syntax");
            ...
            // Sort the student by their branch using method syntax
            Console.WriteLine("\nSort the student by their branch using method syntax");
            var methodSyntax = Student.GetAllStudents().OrderBy(student => student.Branch).ToList();
            ...
            // Sort the student by first name whose branch is CSE using query syntax
            Console.WriteLine("\nSort the student by first name whose branch is CSE using query syntax");
            ...
            // Sort the student by first name whose branch is CSE using method syntax
            Console.WriteLine("\nSort the student by first name whose branch is CSE using method syntax");

            var methodSyntax1 = Student.GetAllStudents().Where(std => std.Branch.ToUpper() == "CSE").OrderBy(std => std.FirstName).ToList();
